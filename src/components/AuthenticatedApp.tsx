...
import { DigitalVotingBooth } from './DigitalVotingBooth';
...
export const AuthenticatedApp: React.FC = () => {
  ...
  const getAvailableTabs = () => {
    ...
    // Register tab - available to enumerators and admins
    if (authService.hasPermission('write:province_citizens') || authService.hasRole('admin')) {
      tabs.push('register');
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-green-50 relative">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsList className={`png-tabs grid w-full max-w-6xl mx-auto mb-8 shadow-lg border-2 border-yellow-400 ${
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-blue-800 space-y-2">
                  <p>
                    {currentProfile?.role === 'admin'
                      ? 'You have full system access including user management, candidate management, and all 21 provinces.'
                      : currentProfile?.role === 'enumerator'
